...
class CalculateEtfMetricsHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        DB::table('performance_range_types')
            ->truncate();

        DB::table('metric_directions')
            ->truncate();

        DB::table('distribution_frequencies')
            ->truncate();

        DB::table('etf_strategy_types')
            ->truncate();

        DB::table('etf_issuers')
            ->truncate();
