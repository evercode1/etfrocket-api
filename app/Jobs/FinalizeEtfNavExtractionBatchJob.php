...
class FinalizeEtfNavExtractionBatchJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        $processingNotes =
            ...
            ? 'AI ETF NAV extraction batch completed with failures.'

            : 'AI ETF NAV extraction batch completed successfully.';
